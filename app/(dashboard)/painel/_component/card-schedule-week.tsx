    ...
    <Card className="w-64 h-64 bg-secondary rounded-xl">
      <CardHeader className="p-4 ">
        <div className="flex gap-1 flex-row flex-wrap items-center">
          <Badge className="w-fit h-fit bg-green-500 text-white bg-opacity-20">
            Barba
          </Badge>
          <Badge className="w-fit h-fit bg-yellow-500 text-white bg-opacity-20">
            Cabelo
          </Badge>
          <Badge className="w-fit h-fit bg-blue-500 text-white bg-opacity-20">
            Hidratação
          </Badge>
          <Badge className="w-fit h-fit bg-purple-500 text-white bg-opacity-20">
            Sonbrancelha
          </Badge>
        </div>
      </CardHeader>
      <CardContent>
        <h1 className="text-gray-300 font-bold text-xl text-wrap w-24">
          Welder N. Fernandes
        </h1>
